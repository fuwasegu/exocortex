...
### 2.2 exo_link_memories の処理フロー

```
┌─────────────────────────────────────────────────────────────┐
│                    exo_link_memories 実行                       │
├─────────────────────────────────────────────────────────────┤
│                                                             │
...
### 3.1 exo_store_memory の処理フロー

`exo_store_memory` が呼ばれると、以下の順序でグラフが構築されます：
...
### 3.2 exo_update_memory の処理フロー

```
┌─────────────────────────────────────────────────────────────┐
│                    exo_update_memory 実行                       │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  contentが指定された場合:                                   │
│  1️⃣ 新しいコンテンツをベクトル化                            │
...
## 4. グラフ探索（exo_explore_related）

### 4.1 探索の3つの軸

`exo_explore_related` は、指定した記憶から3つの方法で関連記憶を発見します：
...
### 7.1 セマンティック検索（exo_recall_memories）

```
┌────────────────────────────────────────────────────┐
│               exo_recall_memories の流れ               │
├────────────────────────────────────────────────────┤
│                                                    │
│  1. クエリをベクトル化                              │
...
### 7.2 グラフ探索（exo_explore_related）

```
┌────────────────────────────────────────────────────┐
│               exo_explore_related の流れ               │
├────────────────────────────────────────────────────┤
│                                                    │
